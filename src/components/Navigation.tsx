...
const socials = [
	{
		href: "https://github.com/fransafu",
		label: "GitHub",
		icon: (
			<svg
				viewBox="0 0 24 24"
	...
	{
		href: "https://linkedin.com/in/fransafu",
		label: "LinkedIn",
		icon: (
			<svg
				viewBox="0 0 24 24"
...
export function Navigation() {
	return (
		<nav className="w-full border-b border-zinc-200 bg-white/70 backdrop-blur-md dark:border-zinc-800 dark:bg-black/70 sticky top-0 z-50">
